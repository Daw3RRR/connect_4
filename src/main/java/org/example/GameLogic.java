...
public class GameLogic {
    public DatabaseManager dbManager; // Az adatbázis kezeléséért felelős példány
    ...
    public AIPlayer aiPlayer; // A gépi játékos objektum
    ...
    public GameSaveManager saveManager = new GameSaveManager(); // A játék mentéséért felelős objektum
    public HighScore highScore; // A magas pontszámokat kezelő objektum
    ...
    public void gameStarter() {
        Scanner scanner = new Scanner(System.in);
        while (startQuestion) { // Végtelen ciklus a helyes választásig
